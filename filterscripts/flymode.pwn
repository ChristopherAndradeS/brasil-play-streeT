...
public OnPlayerConnect(playerid)
{
	...
	noclipdata[playerid][old_pos][0]   	= 0.0;
	noclipdata[playerid][old_pos][1]    = 0.0;
	noclipdata[playerid][old_pos][2]    = 0.0;
	return 1;
}
...
//--------------------------------------------------
forward FlyMode(playerid, Float:X, Float:Y, Float:Z);
public FlyMode(playerid, Float:X, Float:Y, Float:Z)
{
	...
	noclipdata[playerid][old_pos][0] = X;
