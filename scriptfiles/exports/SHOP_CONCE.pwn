...
{
	PublicTD[0] = TextDrawCreate(64.000000, 48.000000, "ld_dual:white");
	TextDrawFont(PublicTD[0], 4);
	TextDrawLetterSize(PublicTD[0], 0.600000, 2.000000);
	TextDrawTextSize(PublicTD[0], 512.000000, 360.000000);
	...
	PublicTD[1] = TextDrawCreate(64.000000, 48.000000, "ld_dual:white");
	...
	TextDrawColor(PublicTD[1], -13412865);
	...
	PublicTD[2] = TextDrawCreate(320.000000, 48.000000, "SHOP CAR");
	TextDrawFont(PublicTD[2], 2);
	TextDrawLetterSize(PublicTD[2], 0.500000, 3.000000);
	TextDrawTextSize(PublicTD[2], 400.000000, 197.000000);
	...
	PublicTD[4] = TextDrawCreate(64.000000, 79.000000, "ld_beat:up");
	TextDrawFont(PublicTD[4], 4);
	TextDrawLetterSize(PublicTD[4], 0.600000, 2.000000);
	TextDrawTextSize(PublicTD[4], 31.000000, 41.500000);
	...
	PublicTD[5] = TextDrawCreate(64.000000, 366.000000, "ld_beat:down");
	TextDrawFont(PublicTD[5], 4);
	TextDrawLetterSize(PublicTD[5], 0.600000, 2.000000);
	TextDrawTextSize(PublicTD[5], 31.000000, 41.500000);
	...
	PublicTD[6] = TextDrawCreate(170.000000, 170.000000, "ld_beat:left");
	...
	PublicTD[7] = TextDrawCreate(420.000000, 170.000000, "ld_beat:right");
	...
	PublicTD[8] = TextDrawCreate(170.000000, 330.000000, "HUD:radar_cash");
	TextDrawFont(PublicTD[8], 4);
	TextDrawLetterSize(PublicTD[8], 0.600000, 2.000000);
	TextDrawTextSize(PublicTD[8], 20.000000, 20.000000);
	...
	PublicTD[9] = TextDrawCreate(170.000000, 300.000000, "HUD:radar_impound");
	TextDrawFont(PublicTD[9], 4);
	TextDrawLetterSize(PublicTD[9], 0.600000, 2.000000);
	TextDrawTextSize(PublicTD[9], 20.000000, 20.000000);
	...
	PublicTD[10] = TextDrawCreate(170.000000, 360.000000, "HUD:radar_centre");
	TextDrawFont(PublicTD[10], 4);
	TextDrawLetterSize(PublicTD[10], 0.600000, 2.000000);
	TextDrawTextSize(PublicTD[10], 20.000000, 20.000000);
	...
	PublicTD[11] = TextDrawCreate(418.000000, 299.000000, "ld_dual:white");
	TextDrawFont(PublicTD[11], 4);
	TextDrawLetterSize(PublicTD[11], 0.600000, 2.000000);
	TextDrawTextSize(PublicTD[11], 145.500000, 40.000000);
	...
	PublicTD[12] = TextDrawCreate(418.000000, 351.000000, "ld_dual:white");
	TextDrawFont(PublicTD[12], 4);
	TextDrawLetterSize(PublicTD[12], 0.600000, 2.000000);
	TextDrawTextSize(PublicTD[12], 145.500000, 40.000000);
	...
	PublicTD[13] = TextDrawCreate(492.500000, 305.000000, "comprar");
	TextDrawFont(PublicTD[13], 2);
	TextDrawLetterSize(PublicTD[13], 0.500000, 3.000000);
	...
	PublicTD[14] = TextDrawCreate(492.500000, 356.000000, "FECHAR");
	TextDrawFont(PublicTD[14], 2);
	TextDrawLetterSize(PublicTD[14], 0.500000, 3.000000);
	...
	PublicTD[15] = TextDrawCreate(170.000000, 385.000000, "COR1:");
	TextDrawFont(PublicTD[15], 2);
	TextDrawLetterSize(PublicTD[15], 0.300000, 1.799999);
	...
	PublicTD[16] = TextDrawCreate(288.000000, 385.000000, "COR2:");
	TextDrawFont(PublicTD[16], 2);
	TextDrawLetterSize(PublicTD[16], 0.300000, 1.799999);
...
{
	PlayerTD[playerid][0] = CreatePlayerTextDraw(playerid, 95.000000, 78.000000, "Preview_Model");
	PlayerTextDrawFont(playerid, PlayerTD[playerid][0], 5);
	PlayerTextDrawLetterSize(playerid, PlayerTD[playerid][0], 0.600000, 2.000000);
	PlayerTextDrawTextSize(playerid, PlayerTD[playerid][0], 66.000000, 66.000000);
	...
	PlayerTextDrawBackgroundColor(playerid, PlayerTD[playerid][0], -13413035);
	...
	PlayerTextDrawSetPreviewModel(playerid, PlayerTD[playerid][0], 412);
	PlayerTextDrawSetPreviewRot(playerid, PlayerTD[playerid][0], -10.000000, 0.000000, -20.000000, 0.750000);
	PlayerTextDrawSetPreviewVehCol(playerid, PlayerTD[playerid][0], 1, 1);

	PlayerTD[playerid][1] = CreatePlayerTextDraw(playerid, 95.000000, 144.000000, "Preview_Model");
	PlayerTextDrawFont(playerid, PlayerTD[playerid][1], 5);
	PlayerTextDrawLetterSize(playerid, PlayerTD[playerid][1], 0.600000, 2.000000);
	PlayerTextDrawTextSize(playerid, PlayerTD[playerid][1], 66.000000, 66.000000);
	...
	PlayerTextDrawBackgroundColor(playerid, PlayerTD[playerid][1], -13413035);
	...
	PlayerTextDrawSetPreviewModel(playerid, PlayerTD[playerid][1], 412);
	PlayerTextDrawSetPreviewRot(playerid, PlayerTD[playerid][1], -10.000000, 0.000000, -20.000000, 0.750000);
	PlayerTextDrawSetPreviewVehCol(playerid, PlayerTD[playerid][1], 1, 1);

	PlayerTD[playerid][2] = CreatePlayerTextDraw(playerid, 95.000000, 210.000000, "Preview_Model");
	PlayerTextDrawFont(playerid, PlayerTD[playerid][2], 5);
	PlayerTextDrawLetterSize(playerid, PlayerTD[playerid][2], 0.600000, 2.000000);
	PlayerTextDrawTextSize(playerid, PlayerTD[playerid][2], 66.000000, 66.000000);
	...
	PlayerTextDrawBackgroundColor(playerid, PlayerTD[playerid][2], -13413035);
	...
	PlayerTextDrawSetPreviewModel(playerid, PlayerTD[playerid][2], 412);
	PlayerTextDrawSetPreviewRot(playerid, PlayerTD[playerid][2], -10.000000, 0.000000, -20.000000, 0.750000);
	PlayerTextDrawSetPreviewVehCol(playerid, PlayerTD[playerid][2], 1, 1);

	PlayerTD[playerid][3] = CreatePlayerTextDraw(playerid, 95.000000, 276.000000, "Preview_Model");
	PlayerTextDrawFont(playerid, PlayerTD[playerid][3], 5);
	PlayerTextDrawLetterSize(playerid, PlayerTD[playerid][3], 0.600000, 2.000000);
	PlayerTextDrawTextSize(playerid, PlayerTD[playerid][3], 66.000000, 66.000000);
	...
	PlayerTextDrawBackgroundColor(playerid, PlayerTD[playerid][3], -13413035);
	...
	PlayerTextDrawSetPreviewModel(playerid, PlayerTD[playerid][3], 412);
	PlayerTextDrawSetPreviewRot(playerid, PlayerTD[playerid][3], -10.000000, 0.000000, -20.000000, 0.750000);
	PlayerTextDrawSetPreviewVehCol(playerid, PlayerTD[playerid][3], 1, 1);

	PlayerTD[playerid][4] = CreatePlayerTextDraw(playerid, 95.000000, 342.000000, "Preview_Model");
	PlayerTextDrawFont(playerid, PlayerTD[playerid][4], 5);
	PlayerTextDrawLetterSize(playerid, PlayerTD[playerid][4], 0.600000, 2.000000);
	PlayerTextDrawTextSize(playerid, PlayerTD[playerid][4], 66.000000, 66.000000);
	...
	PlayerTextDrawBackgroundColor(playerid, PlayerTD[playerid][4], -13413035);
	...
	PlayerTextDrawSetPreviewModel(playerid, PlayerTD[playerid][4], 412);
	PlayerTextDrawSetPreviewRot(playerid, PlayerTD[playerid][4], -10.000000, 0.000000, -20.000000, 0.750000);
	PlayerTextDrawSetPreviewVehCol(playerid, PlayerTD[playerid][4], 1, 1);

	PlayerTD[playerid][5] = CreatePlayerTextDraw(playerid, 230.000000, 100.000000, "Preview_Model");
	PlayerTextDrawFont(playerid, PlayerTD[playerid][5], 5);
	PlayerTextDrawLetterSize(playerid, PlayerTD[playerid][5], 0.600000, 2.000000);
	PlayerTextDrawTextSize(playerid, PlayerTD[playerid][5], 180.000000, 190.000000);
	...
	PlayerTextDrawBackgroundColor(playerid, PlayerTD[playerid][5], 39);
	...
	PlayerTextDrawSetPreviewModel(playerid, PlayerTD[playerid][5], 412);
	PlayerTextDrawSetPreviewRot(playerid, PlayerTD[playerid][5], -5.000000, 0.000000, -20.000000, 0.750000);
	PlayerTextDrawSetPreviewVehCol(playerid, PlayerTD[playerid][5], 1, 1);

	PlayerTD[playerid][6] = CreatePlayerTextDraw(playerid, 64.000000, 125.000000, "ld_dual:white");
	PlayerTextDrawFont(playerid, PlayerTD[playerid][6], 4);
	PlayerTextDrawLetterSize(playerid, PlayerTD[playerid][6], 0.600000, 2.000000);
	PlayerTextDrawTextSize(playerid, PlayerTD[playerid][6], 31.000000, 235.000000);
	...
	PlayerTextDrawColor(playerid, PlayerTD[playerid][6], -13412865);
	...
	PlayerTD[playerid][7] = CreatePlayerTextDraw(playerid, 195.000000, 300.000000, "<VEHICLE_NAME>");
	PlayerTextDrawFont(playerid, PlayerTD[playerid][7], 2);
	PlayerTextDrawLetterSize(playerid, PlayerTD[playerid][7], 0.300000, 1.799999);
	...
	PlayerTD[playerid][8] = CreatePlayerTextDraw(playerid, 195.000000, 330.000000, "999.999,99 ~g~~h~R$~w~/~y~B$");
	PlayerTextDrawFont(playerid, PlayerTD[playerid][8], 2);
	PlayerTextDrawLetterSize(playerid, PlayerTD[playerid][8], 0.300000, 1.799999);
	...
	PlayerTD[playerid][9] = CreatePlayerTextDraw(playerid, 195.000000, 360.000000, "<FUEL_NAME>");
	PlayerTextDrawFont(playerid, PlayerTD[playerid][9], 2);
	PlayerTextDrawLetterSize(playerid, PlayerTD[playerid][9], 0.300000, 1.799999);
