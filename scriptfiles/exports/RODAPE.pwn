...
{Baseboard::
	...
	Baseboard::PublicTD[4] = TextDrawCreate(565.000000, 433.000000, "00:00~n~12_de_fevereiro_de_2026");
...
{
	TextDrawDestroy(Baseboard::PublicTD[0]);
	TextDrawDestroy(Baseboard::PublicTD[1]);
	TextDrawDestroy(Baseboard::PublicTD[2]);
	TextDrawDestroy(Baseboard::PublicTD[3]);
	TextDrawDestroy(Baseboard::PublicTD[4]);
	TextDrawDestroy(Baseboard::PublicTD[5]);
	TextDrawDestroy(Baseboard::PublicTD[6]);
	TextDrawDestroy(Baseboard::PublicTD[7]);
	TextDrawDestroy(Baseboard::PublicTD[8]);
	TextDrawDestroy(Baseboard::PublicTD[9]);
	TextDrawDestroy(Baseboard::PublicTD[10]);
	TextDrawDestroy(Baseboard::PublicTD[11]);
	TextDrawDestroy(Baseboard::PublicTD[12]);
	return 1;
}
...
public OnPlayerConnect(playerid)
{
	...
	Baseboard::PlayerTD[playerid][1] = CreatePlayerTextDraw(playerid, 463.333007, 437.500000, "~b~~h~~h~PAYDAY~w~ 00:00");
...
{
	PlayerTextDrawDestroy(playerid, Baseboard::PlayerTD[playerid][0]);
	PlayerTextDrawDestroy(playerid, Baseboard::PlayerTD[playerid][1]);
	PlayerTextDrawDestroy(playerid, Baseboard::PlayerTD[playerid][2]);
	PlayerTextDrawDestroy(playerid, Baseboard::PlayerTD[playerid][3]);
	PlayerTextDrawDestroy(playerid, Baseboard::PlayerTD[playerid][4]);
	return 1;
}
...
public OnPlayerCommandText(playerid, cmdtext[])
{
	...
	{
		TextDrawShowForPlayer(playerid, Baseboard::PublicTD[0]);
		TextDrawShowForPlayer(playerid, Baseboard::PublicTD[1]);
		TextDrawShowForPlayer(playerid, Baseboard::PublicTD[2]);
		TextDrawShowForPlayer(playerid, Baseboard::PublicTD[3]);
		TextDrawShowForPlayer(playerid, Baseboard::PublicTD[4]);
		TextDrawShowForPlayer(playerid, Baseboard::PublicTD[5]);
		TextDrawShowForPlayer(playerid, Baseboard::PublicTD[6]);
		TextDrawShowForPlayer(playerid, Baseboard::PublicTD[7]);
		TextDrawShowForPlayer(playerid, Baseboard::PublicTD[8]);
		TextDrawShowForPlayer(playerid, Baseboard::PublicTD[9]);
		TextDrawShowForPlayer(playerid, Baseboard::PublicTD[10]);
		TextDrawShowForPlayer(playerid, Baseboard::PublicTD[11]);
		TextDrawShowForPlayer(playerid, Baseboard::PublicTD[12]);
		PlayerTextDrawShow(playerid, Baseboard::PlayerTD[playerid][0]);
		PlayerTextDrawShow(playerid, Baseboard::PlayerTD[playerid][1]);
		PlayerTextDrawShow(playerid, Baseboard::PlayerTD[playerid][2]);
		PlayerTextDrawShow(playerid, Baseboard::PlayerTD[playerid][3]);
		PlayerTextDrawShow(playerid, Baseboard::PlayerTD[playerid][4]);
		return 1;
	}
	return 0;
}
