...
new Text:PublicTD[33];
new PlayerText:PlayerTD[MAX_PLAYERS][27];

public OnFilterScriptInit()
{
	PublicTD[0] = TextDrawCreate(68.000000, 127.500000, "ld_dual:white");
	TextDrawFont(PublicTD[0], 4);
	TextDrawLetterSize(PublicTD[0], 0.600000, 2.000000);
	TextDrawTextSize(PublicTD[0], 216.000000, 251.500000);
	...
	PublicTD[5] = TextDrawCreate(466.000000, 63.000000, "INVENTARIO EXTERNO");
	TextDrawFont(PublicTD[5], 2);
	TextDrawLetterSize(PublicTD[5], 0.300000, 1.799999);
	TextDrawTextSize(PublicTD[5], 400.000000, 257.500000);
	...
	PublicTD[6] = TextDrawCreate(466.000000, 93.000000, "~g~~h~~h~>> ~w~Duplo clique para pegar itens ~g~~h~~h~proximos de voce");
	TextDrawFont(PublicTD[6], 2);
	TextDrawLetterSize(PublicTD[6], 0.250000, 1.500000);
	TextDrawTextSize(PublicTD[6], 569.500000, 216.000000);
	...
	PublicTD[8] = TextDrawCreate(116.000000, 382.000000, "ld_beat:left");
	TextDrawFont(PublicTD[8], 4);
	TextDrawLetterSize(PublicTD[8], 0.600000, 2.000000);
	TextDrawTextSize(PublicTD[8], 40.000000, 50.000000);
	...
	PublicTD[9] = TextDrawCreate(196.000000, 382.000000, "ld_beat:right");
	TextDrawFont(PublicTD[9], 4);
	TextDrawLetterSize(PublicTD[9], 0.600000, 2.000000);
	TextDrawTextSize(PublicTD[9], 40.000000, 50.000000);
	...
	PublicTD[10] = TextDrawCreate(176.000000, 61.000000, "SUA MOCHILA");
	TextDrawFont(PublicTD[10], 2);
	TextDrawLetterSize(PublicTD[10], 0.300000, 1.799999);
	TextDrawTextSize(PublicTD[10], 400.000000, 257.500000);
	TextDrawSetOutline(PublicTD[10], 0);
	TextDrawSetShadow(PublicTD[10], 1);
	...
	PublicTD[21] = TextDrawCreate(320.000000, 192.000000, "DROPAR");
	TextDrawFont(PublicTD[21], 2);
	TextDrawLetterSize(PublicTD[21], 0.300000, 1.799999);
	TextDrawTextSize(PublicTD[21], 400.000000, 257.500000);
	...
	PublicTD[22] = TextDrawCreate(320.000000, 243.000000, "EXCLUIR");
	TextDrawFont(PublicTD[22], 2);
	TextDrawLetterSize(PublicTD[22], 0.300000, 1.799999);
	TextDrawTextSize(PublicTD[22], 400.000000, 257.500000);
	...
	PublicTD[23] = TextDrawCreate(320.000000, 287.000000, "ENVIAR TROCA");
	TextDrawFont(PublicTD[23], 2);
	TextDrawLetterSize(PublicTD[23], 0.300000, 1.799999);
	TextDrawTextSize(PublicTD[23], 400.000000, 33.000000);
	...
	TextDrawUseBox(PublicTD[23], 0);
	TextDrawSetProportional(PublicTD[23], 1);
	TextDrawSetSelectable(PublicTD[23], 0);

	PublicTD[24] = TextDrawCreate(320.000000, 346.000000, "FECHAR");
	TextDrawFont(PublicTD[24], 2);
	TextDrawLetterSize(PublicTD[24], 0.300000, 1.799999);
	TextDrawTextSize(PublicTD[24], 400.000000, 41.500000);
	...
	PublicTD[26] = TextDrawCreate(112.750000, 136.750000, "HUD:radar_burgershot");
	TextDrawFont(PublicTD[26], 4);
	TextDrawLetterSize(PublicTD[26], 0.600000, 2.000000);
	TextDrawTextSize(PublicTD[26], 20.000000, 20.000000);
	...
	PublicTD[27] = TextDrawCreate(148.250000, 136.750000, "hud:radar_dateDisco");
	TextDrawFont(PublicTD[27], 4);
	TextDrawLetterSize(PublicTD[27], 0.600000, 2.000000);
	TextDrawTextSize(PublicTD[27], 20.000000, 20.000000);
	...
	PublicTD[28] = TextDrawCreate(219.250000, 136.750000, "HUD:radar_tshirt");
	TextDrawFont(PublicTD[28], 4);
	TextDrawLetterSize(PublicTD[28], 0.600000, 2.000000);
	TextDrawTextSize(PublicTD[28], 20.000000, 20.000000);
	...
	PublicTD[29] = TextDrawCreate(183.750000, 136.750000, "HUD:radar_hostpital");
	TextDrawFont(PublicTD[29], 4);
	TextDrawLetterSize(PublicTD[29], 0.600000, 2.000000);
	TextDrawTextSize(PublicTD[29], 20.000000, 20.000000);
	...
	PublicTD[30] = TextDrawCreate(254.750000, 136.750000, "HUD:radar_ammugun");
	TextDrawFont(PublicTD[30], 4);
	TextDrawLetterSize(PublicTD[30], 0.600000, 2.000000);
	TextDrawTextSize(PublicTD[30], 20.000000, 20.000000);
	...
	PublicTD[31] = TextDrawCreate(486.000000, 382.000000, "ld_beat:right");
	TextDrawFont(PublicTD[31], 4);
	TextDrawLetterSize(PublicTD[31], 0.600000, 2.000000);
	TextDrawTextSize(PublicTD[31], 40.000000, 50.000000);
	...
	PublicTD[32] = TextDrawCreate(406.000000, 382.000000, "ld_beat:left");
	TextDrawFont(PublicTD[32], 4);
	TextDrawLetterSize(PublicTD[32], 0.600000, 2.000000);
	TextDrawTextSize(PublicTD[32], 40.000000, 50.000000);
...
{
	PlayerTD[playerid][0] = CreatePlayerTextDraw(playerid, 186.000000, 99.000000, "SLOTS: ~w~0/36");
	PlayerTextDrawFont(playerid, PlayerTD[playerid][0], 2);
	PlayerTextDrawLetterSize(playerid, PlayerTD[playerid][0], 0.300000, 1.799999);
	PlayerTextDrawTextSize(playerid, PlayerTD[playerid][0], 542.000000, 338.000000);
	...
	PlayerTextDrawColor(playerid, PlayerTD[playerid][0], 872389119);
	...
	PlayerTD[playerid][1] = CreatePlayerTextDraw(playerid, 176.000000, 391.000000, "1/4");
	PlayerTextDrawFont(playerid, PlayerTD[playerid][1], 2);
	PlayerTextDrawLetterSize(playerid, PlayerTD[playerid][1], 0.449999, 2.700000);
	PlayerTextDrawTextSize(playerid, PlayerTD[playerid][1], 400.000000, 257.500000);
	...
	PlayerTD[playerid][2] = CreatePlayerTextDraw(playerid, 77.000000, 99.000000, "PESO: ~w~0.0/10.0");
	PlayerTextDrawFont(playerid, PlayerTD[playerid][2], 2);
	PlayerTextDrawLetterSize(playerid, PlayerTD[playerid][2], 0.300000, 1.799999);
	PlayerTextDrawTextSize(playerid, PlayerTD[playerid][2], 542.000000, 338.000000);
	...
	PlayerTextDrawColor(playerid, PlayerTD[playerid][2], 872389119);
	...
	PlayerTD[playerid][3] = CreatePlayerTextDraw(playerid, 70.000000, 165.000000, "Preview_Model");
	...
	PlayerTextDrawBackgroundColor(playerid, PlayerTD[playerid][3], 295270314);
	...
	PlayerTD[playerid][4] = CreatePlayerTextDraw(playerid, 141.000000, 165.000000, "Preview_Model");
	...
	PlayerTextDrawBackgroundColor(playerid, PlayerTD[playerid][4], 295270314);
	...
	PlayerTD[playerid][5] = CreatePlayerTextDraw(playerid, 212.000000, 165.000000, "Preview_Model");
	...
	PlayerTextDrawBackgroundColor(playerid, PlayerTD[playerid][5], 295270314);
	...
	PlayerTD[playerid][6] = CreatePlayerTextDraw(playerid, 70.000000, 236.000000, "Preview_Model");
	...
	PlayerTextDrawBackgroundColor(playerid, PlayerTD[playerid][6], 295270314);
	...
	PlayerTD[playerid][7] = CreatePlayerTextDraw(playerid, 141.000000, 236.000000, "Preview_Model");
	PlayerTextDrawFont(playerid, PlayerTD[playerid][7], 5);
	PlayerTextDrawLetterSize(playerid, PlayerTD[playerid][7], 0.600000, 2.000000);
	PlayerTextDrawTextSize(playerid, PlayerTD[playerid][7], 70.000000, 70.000000);
	...
	PlayerTextDrawBackgroundColor(playerid, PlayerTD[playerid][7], 295270314);
	...
	PlayerTD[playerid][8] = CreatePlayerTextDraw(playerid, 212.000000, 236.000000, "Preview_Model");
	PlayerTextDrawFont(playerid, PlayerTD[playerid][8], 5);
	PlayerTextDrawLetterSize(playerid, PlayerTD[playerid][8], 0.600000, 2.000000);
	PlayerTextDrawTextSize(playerid, PlayerTD[playerid][8], 70.000000, 70.000000);
	...
	PlayerTextDrawBackgroundColor(playerid, PlayerTD[playerid][8], 295270314);
	...
	PlayerTD[playerid][9] = CreatePlayerTextDraw(playerid, 70.000000, 307.000000, "Preview_Model");
	PlayerTextDrawFont(playerid, PlayerTD[playerid][9], 5);
	PlayerTextDrawLetterSize(playerid, PlayerTD[playerid][9], 0.600000, 2.000000);
	PlayerTextDrawTextSize(playerid, PlayerTD[playerid][9], 70.000000, 70.000000);
	...
	PlayerTextDrawBackgroundColor(playerid, PlayerTD[playerid][9], 295270314);
	...
	PlayerTextDrawSetPreviewModel(playerid, PlayerTD[playerid][9], 18631);
	...
	PlayerTD[playerid][10] = CreatePlayerTextDraw(playerid, 141.000000, 307.000000, "Preview_Model");
	...
	PlayerTextDrawTextSize(playerid, PlayerTD[playerid][10], 70.000000, 70.000000);
	...
	PlayerTextDrawBackgroundColor(playerid, PlayerTD[playerid][10], 295270314);
	...
	PlayerTextDrawSetPreviewModel(playerid, PlayerTD[playerid][10], 18631);
	...
	PlayerTD[playerid][11] = CreatePlayerTextDraw(playerid, 212.000000, 307.000000, "Preview_Model");
	...
	PlayerTextDrawTextSize(playerid, PlayerTD[playerid][11], 70.000000, 70.000000);
	...
	PlayerTextDrawBackgroundColor(playerid, PlayerTD[playerid][11], 295270314);
	...
	PlayerTD[playerid][12] = CreatePlayerTextDraw(playerid, 286.000000, 178.000000, "ld_dual:white");
	...
	PlayerTextDrawTextSize(playerid, PlayerTD[playerid][12], 70.000000, 48.700000);
	...
	PlayerTextDrawColor(playerid, PlayerTD[playerid][12], 1097458175);
	...
	PlayerTD[playerid][13] = CreatePlayerTextDraw(playerid, 286.000000, 229.000000, "ld_dual:white");
	...
	PlayerTextDrawTextSize(playerid, PlayerTD[playerid][13], 70.000000, 48.700000);
	...
	PlayerTextDrawColor(playerid, PlayerTD[playerid][13], -1962934017);
	...
	PlayerTD[playerid][14] = CreatePlayerTextDraw(playerid, 360.000000, 129.500000, "Preview_Model");
	...
	PlayerTextDrawTextSize(playerid, PlayerTD[playerid][14], 70.000000, 61.125000);
	...
	PlayerTextDrawBackgroundColor(playerid, PlayerTD[playerid][14], 295270314);
	...
	PlayerTextDrawSetPreviewModel(playerid, PlayerTD[playerid][14], 18631);
	...
	PlayerTD[playerid][15] = CreatePlayerTextDraw(playerid, 431.000000, 129.500000, "Preview_Model");
	...
	PlayerTextDrawTextSize(playerid, PlayerTD[playerid][15], 70.000000, 61.125000);
	...
	PlayerTextDrawBackgroundColor(playerid, PlayerTD[playerid][15], 295270314);
	...
	PlayerTextDrawSetPreviewModel(playerid, PlayerTD[playerid][15], 18631);
	...
	PlayerTD[playerid][16] = CreatePlayerTextDraw(playerid, 502.000000, 129.500000, "Preview_Model");
	...
	PlayerTextDrawTextSize(playerid, PlayerTD[playerid][16], 70.000000, 61.125000);
	...
	PlayerTextDrawBackgroundColor(playerid, PlayerTD[playerid][16], 295270314);
	...
	PlayerTextDrawSetPreviewModel(playerid, PlayerTD[playerid][16], 18631);
	...
	PlayerTD[playerid][17] = CreatePlayerTextDraw(playerid, 360.000000, 191.625000, "Preview_Model");
	...
	PlayerTextDrawTextSize(playerid, PlayerTD[playerid][17], 70.000000, 61.125000);
	...
	PlayerTextDrawBackgroundColor(playerid, PlayerTD[playerid][17], 295270314);
	...
	PlayerTextDrawSetPreviewModel(playerid, PlayerTD[playerid][17], 18631);
	...
	PlayerTD[playerid][18] = CreatePlayerTextDraw(playerid, 431.000000, 191.625000, "Preview_Model");
	PlayerTextDrawFont(playerid, PlayerTD[playerid][18], 5);
	PlayerTextDrawLetterSize(playerid, PlayerTD[playerid][18], 0.600000, 2.000000);
	PlayerTextDrawTextSize(playerid, PlayerTD[playerid][18], 70.000000, 61.125000);
	...
	PlayerTextDrawBackgroundColor(playerid, PlayerTD[playerid][18], 295270314);
	PlayerTextDrawBoxColor(playerid, PlayerTD[playerid][18], 255);
	...
	PlayerTextDrawSetPreviewModel(playerid, PlayerTD[playerid][18], 18631);
	PlayerTextDrawSetPreviewRot(playerid, PlayerTD[playerid][18], -10.000000, 0.000000, -20.000000, 1.000000);
	PlayerTextDrawSetPreviewVehCol(playerid, PlayerTD[playerid][18], 1, 1);

	PlayerTD[playerid][19] = CreatePlayerTextDraw(playerid, 502.000000, 191.625000, "Preview_Model");
	...
	PlayerTextDrawTextSize(playerid, PlayerTD[playerid][19], 70.000000, 61.125000);
	...
	PlayerTextDrawBackgroundColor(playerid, PlayerTD[playerid][19], 295270314);
	...
	PlayerTextDrawSetPreviewRot(playerid, PlayerTD[playerid][19], -10.000000, 0.000000, -20.000000, 1.000000);
	PlayerTextDrawSetPreviewVehCol(playerid, PlayerTD[playerid][19], 1, 1);

	PlayerTD[playerid][20] = CreatePlayerTextDraw(playerid, 360.000000, 253.750000, "Preview_Model");
	...
	PlayerTextDrawTextSize(playerid, PlayerTD[playerid][20], 70.000000, 61.125000);
	...
	PlayerTextDrawBackgroundColor(playerid, PlayerTD[playerid][20], 295270314);
	...
	PlayerTextDrawSetPreviewRot(playerid, PlayerTD[playerid][20], -10.000000, 0.000000, -20.000000, 1.000000);
	PlayerTextDrawSetPreviewVehCol(playerid, PlayerTD[playerid][20], 1, 1);

	PlayerTD[playerid][21] = CreatePlayerTextDraw(playerid, 431.000000, 253.750000, "Preview_Model");
	...
	PlayerTextDrawTextSize(playerid, PlayerTD[playerid][21], 70.000000, 61.125000);
	...
	PlayerTextDrawBackgroundColor(playerid, PlayerTD[playerid][21], 295270314);
	...
	PlayerTextDrawSetPreviewRot(playerid, PlayerTD[playerid][21], -10.000000, 0.000000, -20.000000, 1.000000);
	PlayerTextDrawSetPreviewVehCol(playerid, PlayerTD[playerid][21], 1, 1);

	PlayerTD[playerid][22] = CreatePlayerTextDraw(playerid, 502.000000, 253.750000, "Preview_Model");
	...
	PlayerTextDrawTextSize(playerid, PlayerTD[playerid][22], 70.000000, 61.125000);
	...
	PlayerTextDrawBackgroundColor(playerid, PlayerTD[playerid][22], 295270314);
	...
	PlayerTextDrawSetPreviewRot(playerid, PlayerTD[playerid][22], -10.000000, 0.000000, -20.000000, 1.000000);
	PlayerTextDrawSetPreviewVehCol(playerid, PlayerTD[playerid][22], 1, 1);

	PlayerTD[playerid][23] = CreatePlayerTextDraw(playerid, 360.000000, 315.875000, "Preview_Model");
	...
	PlayerTextDrawTextSize(playerid, PlayerTD[playerid][23], 70.000000, 61.125000);
	...
	PlayerTextDrawBackgroundColor(playerid, PlayerTD[playerid][23], 295270314);
	...
	PlayerTextDrawSetPreviewRot(playerid, PlayerTD[playerid][23], -10.000000, 0.000000, -20.000000, 1.000000);
	PlayerTextDrawSetPreviewVehCol(playerid, PlayerTD[playerid][23], 1, 1);

	PlayerTD[playerid][24] = CreatePlayerTextDraw(playerid, 431.000000, 315.875000, "Preview_Model");
	...
	PlayerTextDrawTextSize(playerid, PlayerTD[playerid][24], 70.000000, 61.125000);
	...
	PlayerTextDrawBackgroundColor(playerid, PlayerTD[playerid][24], 295270314);
	...
	PlayerTextDrawSetPreviewRot(playerid, PlayerTD[playerid][24], -10.000000, 0.000000, -20.000000, 1.000000);
	PlayerTextDrawSetPreviewVehCol(playerid, PlayerTD[playerid][24], 1, 1);

	PlayerTD[playerid][25] = CreatePlayerTextDraw(playerid, 502.000000, 315.875000, "Preview_Model");
	...
	PlayerTextDrawTextSize(playerid, PlayerTD[playerid][25], 70.000000, 61.125000);
	...
	PlayerTextDrawBackgroundColor(playerid, PlayerTD[playerid][25], 295270314);
	...
	PlayerTextDrawSetPreviewRot(playerid, PlayerTD[playerid][25], -10.000000, 0.000000, -20.000000, 1.000000);
	PlayerTextDrawSetPreviewVehCol(playerid, PlayerTD[playerid][25], 1, 1);

	PlayerTD[playerid][26] = CreatePlayerTextDraw(playerid, 466.000000, 391.000000, "1/4");
	PlayerTextDrawFont(playerid, PlayerTD[playerid][26], 2);
	PlayerTextDrawLetterSize(playerid, PlayerTD[playerid][26], 0.449999, 2.700000);
	PlayerTextDrawTextSize(playerid, PlayerTD[playerid][26], 400.000000, 257.500000);
	PlayerTextDrawSetOutline(playerid, PlayerTD[playerid][26], 0);
	PlayerTextDrawSetShadow(playerid, PlayerTD[playerid][26], 1);
